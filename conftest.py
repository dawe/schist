...
scs.inference.fit_model(adata, nested=True , neighbors_key='foo', n_init=2)
...
print("PLANTED MODEL")
scs.inference.fit_model(adata, assortative=True, use_weights=False, save_model='foo', n_init=2, refine_iter=2)
