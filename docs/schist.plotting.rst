***********************
schist.plotting package
***********************

schist.plotting._alluvial
#########################

::

    schist.plotting._alluvial(adata: AnnData, level_start: 1, level_end: None, key: 'nsbm', gap: 0.05) 

Generate an alluvial plot for NSBM hierarchy. 

This plot may be useful to study the hierarchical relations in a Nested Model generated by ``schist.inference.nested_model`` .
